...
export const roleCapabilities: Record<Role, readonly Capability[]> = {
  ...
  designer: ["workspace.read", "project.read", "project.update", "task.read", "task.create", "task.update", "document.read", "document.upload", "document.update", "deliverable.read", "deliverable.create"],
  developer: ["workspace.read", "project.read", "project.update", "task.read", "task.create", "task.update", "document.read", "document.upload", "document.update", "deliverable.read", "deliverable.create"],
  ...
  viewer: ["partner.read", "workspace.read", "discovery.read", "proposal.read", "strategy.read", "project.read", "task.read", "document.read", "deliverable.read", "insight.read", "meeting.read"],
};
