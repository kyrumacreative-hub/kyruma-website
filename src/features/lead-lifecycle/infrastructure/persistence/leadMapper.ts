...
export interface LeadPersistenceModel { id: string; organizationId: string; ownerId: string; primaryContactId: string; origin: string; status: string; createdAt: Date; createdBy: string; archivedAt?: Date; archivedBy?: string; archiveReason?: string; }
