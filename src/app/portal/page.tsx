...
export default async function PortalPage() {
  ...
  if (!membership?.scope.organizationId || !membership.scope.partnerId || !membership.scope.workspaceId) {
    if (isInternalAdminEmail(actor.user.email)) redirect("/access/admin");
